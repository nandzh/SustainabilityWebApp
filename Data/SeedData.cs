...
namespace SustainabilityWebApp.Data
{
    public static class SeedData
    {
        public static void SeedFromExcel(IServiceProvider serviceProvider, string filePath)
        {
            ...
            {
                throw new NullReferenceException("Null BlazorWebAppMoviesContext or Brand DbSet");
            }
            ...
            ExcelPackage.License.SetNonCommercialPersonal("me yamo te aj");
            ...
            for (int row = 2; row <= rowCount; row++) 
            {
                ...
                var brand = new Brand
                {
                    ...
                    CountryOfOrigin = worksheet.Cells[row, 2].Text,
                    ...
                    SmileyFace = worksheet.Cells[row, 7].Text,
                    Rated = worksheet.Cells[row, 8].Text
                };
